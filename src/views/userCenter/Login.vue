                ...
                <el-form-item class="ipt-out" prop="age">
                    <el-row>
                        <el-col class="code-out" :span="15">
                            <el-input prefix-icon="../../assets/images/icon_user.png" class="ipt-code" placeholder="请输入验证码" v-model="ruleForm.age"></el-input>
                            <img src="../../assets/images/icon_pen.png" class="icon_tips2" alt="" />
                        </el-col>
                        <el-col :span="6">
                            <img :src="captchaImg" @click="toggle" alt="" />
                        </el-col>
                    </el-row>
                </el-form-item>
                <el-form-item>
...
export default {
    ...
    methods: {
        ...mapActions(["userLogin", "userCaptcha", "userCheckCaptcha"]),
        async toggle() {
            //图形验证码
        ...
        async loginUser() {
            if (this.ruleForm.userName.indexOf(" ") != -1) {
                ...
                this.$message("验证码不能为空");
            } else if (this.ruleForm.age.length != 4) {
                this.$message("验证码错误");
            } else {
                //校验图形验证码
                let use = await this.userCheckCaptcha({
                    captcha: this.ruleForm.age,
                })
